...
#'        "negbinomial". Defaults to gaussian.
...
#' @param maxit Maximum theta optimzation iteration Defaults to 5.
...
h2o.glm <- function(x, y, training_frame,
                    ...
                    offset_column = NULL,
                    weights_column = NULL,
                    family = c("gaussian", "binomial", "quasibinomial", "ordinal", "multinomial", "poisson", "gamma", "tweedie", "negbinomial"),
