...
class H2OGeneralizedLinearEstimator(H2OEstimator):
    ...
    def __init__(self, **kwargs):
        ...
        names_list = {"model_id", "training_frame", "validation_frame", "nfolds", "seed",
                      ...
                      "family", "tweedie_variance_power", "tweedie_link_power", "maxit", "theta", "optimize_theta",
    ...
    def maxit(self):
        """
        Maximum theta optimzation iteration

        Type: ``int``  (default: ``5``).
        """
        return self._parms.get("maxit")

    @maxit.setter
    def maxit(self, maxit):
        assert_is_type(maxit, None, int)
        self._parms["maxit"] = maxit
